...
namespace Meebey.SmartIrc4net
{
    ...
    public class IrcFeatures : IrcClient
    {
        ...
        public void SendFile(string user, string filepath)
        {
            ...
            if (fi.Exists) {
                this.SendFile(user, new FileStream(filepath, FileMode.Open, FileAccess.Read), fi.Name, fi.Length, DccSpeed.RfcSendAhead, false, Priority.Medium);
            }
        }
        ...
        {
            SendMessage(SendType.CtcpReply, e.Data.Nick, "VERSION " + ((_CtcpVersion==null)?VersionString:_CtcpVersion));
        }
        ...
        private void RemoveInvalidDccConnections()
        {
            ...
            foreach (DccConnection dc in invalidDc) {
                ...
                //TODO: upnp remove redirect (or somewhere else?)
            }
        }
